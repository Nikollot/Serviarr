...
<div class="settings-inner">
    ...
    <div class="settings-section">
        ...
        <div class="settings-section-body settings-body-sm">
            <div class="form-row"><label><?= t('settings_current_pw') ?></label><input type="password" id="pw-current" placeholder="••••••••"></div>
            <div class="form-row"><label><?= t('settings_new_pw') ?></label><input type="password" id="pw-new" placeholder="••••••••"></div>
            <div class="form-row"><label><?= t('settings_confirm_pw') ?></label><input type="password" id="pw-confirm" placeholder="••••••••"></div>
