...
<button class="btn-pill" style="background:var(--bg2); color:var(--text); border:1px solid var(--border); padding:8px 16px; font-weight:bold; margin-left:auto;" onclick="openImportListModal('serie')">📋 <?= t('import_list_btn') ?></button>
