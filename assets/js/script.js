...
async function openTorrentDetail(id) {
    ...
    <div style="font-size:10px; color:var(--muted); margin-bottom:4px; text-transform:uppercase; letter-spacing:0.5px;">Téléchargé</div>
    <div style="font-size:13px; font-weight:600;">${downloaded} / ${size}</div>
    </div>
    <div style="background:var(--bg2); border:1px solid var(--border); border-radius:var(--radius); padding:12px;">
    <div style="font-size:10px; color:var(--muted); margin-bottom:4px; text-transform:uppercase; letter-spacing:0.5px;">Envoyé · Ratio</div>
    <div style="font-size:13px; font-weight:600;">${uploaded} · ${ratio}</div>
    </div>
    <div style="background:var(--bg2); border:1px solid var(--border); border-radius:var(--radius); padding:12px;">
    <div style="font-size:10px; color:var(--muted); margin-bottom:4px; text-transform:uppercase; letter-spacing:0.5px;">Temps restant</div>
    <div style="font-size:13px; font-weight:600;">${eta}</div>
    </div>
    <div style="background:var(--bg2); border:1px solid var(--border); border-radius:var(--radius); padding:12px;">
    <div style="font-size:10px; color:var(--muted); margin-bottom:4px; text-transform:uppercase; letter-spacing:0.5px;">Pairs connectés</div>
    <div style="font-size:13px; font-weight:600;">${totalPeers} (S:${seeders} L:${leechers})</div>
    </div>
    </div>
...
function showDockerLogs(id, name) {
    ...
    <button onclick="document.getElementById('modal-docker-logs').classList.remove('open')" class="btn-circle" style="flex-shrink:0; margin-left:15px; background:var(--bg3); border:1px solid var(--border); color:var(--text); width:32px; height:32px; border-radius:8px; cursor:pointer;">✕</button>
    </h3>
...
function showDockerStats(id, name) {
    ...
    <button onclick="document.getElementById('modal-docker-stats').classList.remove('open')" class="btn-circle" style="flex-shrink:0; margin-left:15px; background:var(--bg3); border:1px solid var(--border); color:var(--text); width:32px; height:32px; border-radius:8px; cursor:pointer;">✕</button>
    </h3>
...
async function loadNotifMenuData() {
    ...
    if (!r || r.length === 0) {
        list.innerHTML = `<div style="padding:15px; text-align:center; color:var(--muted); font-size:13px;">${t('no_recent_dl')}</div>`;
        return;
    }
