...
function download_fields() {
    return [
        ['key' => 'client', 'label' => t('driver_label_download_client'), 'type' => 'select', 'options' => [
            ['value' => 'transmission', 'label' => 'Transmission'],
            ['value' => 'qbittorrent', 'label' => 'qBittorrent'],
        ]],
        ['key' => 'url',      'label' => t('api_url_label'), 'type' => 'text', 'placeholder' => 'http://192.168.1.x:9091'],
        ['key' => 'username', 'label' => t('trans_user_label'), 'type' => 'text', 'placeholder' => t('driver_placeholder_username_hint')],
        ['key' => 'password', 'label' => t('auth_password'), 'type' => 'password', 'placeholder' => t('driver_placeholder_password_hint')],
        ['key' => 'api_key',  'label' => t('api_key_qbt_label'), 'type' => 'text', 'placeholder' => 'qbt_...'],
    ];
}
...
function download_status($cfg) {
    ...
    switch ($client) {
        ...
        default:             return ['ok' => false, 'error' => function_exists('t') ? t('err_client_not_supported') : 'Client non supporté'];
    }
}
...
function _status_qbittorrent($cfg) {
    ...
    if ($code === 403) {
        return ['ok' => false, 'error' => function_exists('t') ? t('err_qbt_invalid_session') : 'Clé API ou session qBittorrent invalide'];
    }
...
function _status_utorrent($cfg) { return ['ok' => true, 'stats' => [['label' => 'Logiciel', 'value' => 'uTorrent']], 'items' => []]; }<?php
// Driver: Download (Multi-support)
// Supported clients: transmission, qbittorrent, deluge, utorrent
